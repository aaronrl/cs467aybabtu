...
namespace AYBABTU
{
    class IMAPHandler
    {
        ...
        private void run()
        {
            ...
            if (!(con == SUCCESS))
            {
                Console.WriteLine("CONNECT ERROR: " + con);
                return;
            }

            string[] fol = retrieveFolders();
            int errorcode = getErrorCode();
            if (errorcode!=SUCCESS)
            {
                Console.WriteLine("FOLDER ERROR: " + errorcode);
                return;
            }
            Console.WriteLine("FOLDERS:");
            TextWriter tw = new StreamWriter("C:\\imap.txt");
            for (int j = 0; j < fol.Length; j++)
            {
                Console.WriteLine(fol[j]);
                string[] messages = getAllMessages(fol[j], -1);
               // string[] uidsNew = getNewMessages(fol[j], null);
                if (!(messages == null))
                {
                    ...
                    foreach (string message in messages)
                    {
                        ...
                        tw.WriteLine(); tw.WriteLine(); tw.WriteLine(); tw.WriteLine(); tw.WriteLine(); tw.WriteLine();
                    }
       ...
       //         {
         //           Console.WriteLine("uids:");
           //         foreach (string id in uidsNew)
            ...
            {
                int mes = retrieveMessages(folders[i]);
        ...
        static void Main(string[] args)
        {
            ...
            IMAPHandler IMAP = new IMAPHandler("imapa.student.gvsu.edu", "blah", "");
            //IMAP.run();
            Console.WriteLine("\n\n\n\n\n\n\n");
            IMAPHandler IMAPa = new IMAPHandler("imap.student.gvsu.edu", "blah", "");
            //IMAPa.run();

            Console.WriteLine("\n\n\n\n\n\n\n");
            IMAPHandler IMAP2 = new IMAPHandler("imap.student.gvsu.edu", "paslasks", "asd");
            //IMAP2.run();

            Console.WriteLine("\n\n\n\n\n\n\n");
            IMAPHandler IMAP3 = new IMAPHandler("imap.student.gvsu.edu", "paslasks", "stephen");
            //IMAP3.run();
            Console.WriteLine("\n\n\n\n\n\n\n");
            IMAPHandler IMAP0 = new IMAPHandler("mail.i2k.com", "cs467sasdtephen", "paslasks");
            //IMAP0.run();
            Console.WriteLine("\n\n\n\n\n\n\n");
            IMAPHandler IMAP0aa = new IMAPHandler("mail.i2k.com", "cs467stephen", "paslasdasks");
            //IMAP0aa.run();
            Console.WriteLine("\n\n\n\n\n\n\n");
            IMAPHandler IMAP0a = new IMAPHandler("mail.i2k.com", "cs467stephen", "paslasks");
            IMAP0a.run();
            Console.WriteLine("\n\n\n\n\n\n\n");
            IMAPHandler IMAPssl = new IMAPHandler("imap.gmail.com", "aaaaaabbahasdiasllkasdjdnsainklas", "aas", 993);
            //IMAPssl.run();
            Console.WriteLine("\n\n\n\n\n\n\n");
            IMAPHandler IMAPssl2 = new IMAPHandler("imap.gmail.com", "paslasks@gmail.com", "8824a$te9", 993);
            //IMAPssl2.run();

            Console.WriteLine("\n\n\n\n\n\n\n");
            IMAPHandler IMAPssl2a = new IMAPHandler("imap.gmail.com", "paslasks@gmail.com", "8824$te9", 993);
            //IMAPssl2a.run();
